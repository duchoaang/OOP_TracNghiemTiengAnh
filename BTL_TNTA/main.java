...
public class main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        User u3 = new User("Admin", "Dong Lak", "Nam", "24/06/2002", USER_ROLE.Admin);
        dsUser.themUser(u1);
        dsUser.themUser(u2);
        dsUser.themUser(u3);
        Menu();
            ...
            switch (permisstion) {
                case 1:
                    ...
                    while (flagLogin) {
                        ...
                        user_present = Integer.parseInt(CAUHINH.sc.nextLine());
                        if (dsUser.timKiemTonTai(user_present) != null) {
                            System.out.println("Dang nhap thanh cong");
                            flagLogin = false;
                        } else {
                            System.out.println("Dang nhap that bai. Hay dang nhap lai, ban duoc 3 lan dang nhap");
                        }
                        if (dem == 3) {
                            System.out.println("Sai qua 3 lan. Tam biet!");
                            flagLogin = false;
                            flagUser = false;
                        }
                    }
                    ...
                    while (flagUser) {
                        ...
                        switch (chon) {
                            case 1:
                                if (dsUser.timKiem(user_present) != null) {
                                    dsUser.timKiem(user_present).hienThi();
                                } else {
                            ...
                            case 5:
                                ...
                                luyenTapUser(user_present);
                                break;
                            case 6:
                                System.out.println("=== Thong ke === ");
                                thongKeUser(user_present);
                                break;
                            default:
                        ...
                        int temp2 = Integer.parseInt(CAUHINH.sc.nextLine());

                        if (temp2 == 2) {
                            flagUser = false;
                            System.out.println("Ban da thoat quyen user");
                            break;
                        }
                    }
                    break;
                ...
                case 2:
                    ...
                    while (flagAdmin){
                        if (userTemp.getRole().getId() == 2) {
                            ...
                            System.out.println("Bạn chọn chức năng : ");
                            int chonAdmin;
                            chonAdmin = Integer.parseInt(CAUHINH.sc.nextLine());
                            switch (chonAdmin) {
                                case 1:
    ...
    public static void thongKeUser(int id) {
        int temp = 0;
        double diemTong = 0;
        if (dsUser.timKiem(id) != null) {
            User user = dsUser.timKiem(id);
